...
const TOY_DEFINITIONS := {
	...
	&"balloon": {
		...
		"scale_preset": &"large",
		"shape": &"circle",
		"collision_size_scale": Vector2(0.70, 0.70),
		"collision_offset": Vector2(0.0, -12.0),
		"gravity_scale": 0.12,
		"mass": 0.14,
		"linear_damp": 1.35,
		"angular_damp": 2.4,
	...
	&"jelly_cube": {
		...
		"scale_preset": &"medium",
		"shape": &"rectangle",
		"collision_size_scale": Vector2(0.84, 0.78),
	...
	&"pot": {
		...
		"scale_preset": &"medium",
		"shape": &"vase",
		"collision_size_scale": Vector2(0.84, 0.76),
	...
	&"sticky_block": {
		...
		"scale_preset": &"wide",
		"shape": &"rectangle",
		"collision_size_scale": Vector2(0.86, 0.74),
